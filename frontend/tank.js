    ...
    Tank.prototype = {
        initialize: function () {
            ...
            this.blinkParts.forEach(function(entity) {
                if (entity.script.tank_sub_model && entity.script.tank_sub_model.teamColor) {
        ...
        setColor: function(r, g, b) {
            for(var i = 0; i < this.teamParts.length; i++) {
                ...
                for(var n = 0; n < meshes.length; n++) {
                    if (meshes[n].material.emissiveMap) {
                        meshes[n].material.emissive.set(r, g, b);
                        meshes[n].material.update();
                    }
                }
            }
