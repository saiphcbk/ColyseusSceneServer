pc.script.create('infoBox', function (context) {
    var InfoBox = function (entity) {
        ...
        */};
        ...
        modal.innerHTML += '<p>Fork of <a href="http://playcanv.as/p/aP0oxhUr" target="_blank">tanx</a> to demonstrate <a href="https://github.com/gamestdio/colyseus" target="_blank">Colyseus</a> features.</p>';
        modal.innerHTML += '<p><a href="http://github.com/endel/tanx" target="_blank">View source code</a></p>';
