...
var ClusterServer = /** @class */ (function () {
    function ClusterServer(options) {
        ...
        if (cluster.isMaster) {
            ...
            Utils_1.registerGracefulShutdown(function (signal) {
                ...
                _this.matchMakingWorker.removeAllListeners();
                _this.matchMakingWorker.kill(signal);
                Master_1.onWorkersShutdown.
    ...
    ClusterServer.prototype.onShutdown = function (callback) {
